...
apt -qq install conky-all -y 
#apt install conky -y
#--- Configure conky
file=/home/nu11secur1ty/.conkyrc; [ -e $file ] && cp -n $file{,.bkup}
...
file=/home/$your_dir/conky.sh; [ -e $file ] && cp -n $file{,.bkup}
...
if [ -e /home/nu11secur1ty/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-keyboard-shortcuts.xml ]; then
  ...
  file=/home/$your_dir/conky_refresh.sh; [ -e $file ] && cp -n $file{,.bkup}
